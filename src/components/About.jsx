...
const About = () => {
  return (
    <section id="about" className="py-6"> {/* Reduced vertical padding */}
      <h2 className="my-6 text-center text-3xl lg:text-8xl text-customText2 dark:text-darkText2"> {/* Reduced top and bottom margin */}
        About Me
      </h2>
      ...
      {/* Education Section */}
      <h2 className="my-6 text-center text-3xl lg:text-6xl text-customText2 dark:text-darkText2"> 
        Education
      </h2>
      <div className="mx-auto max-w-6xl">
        {EDUCATION.map((education, id) => (
          <div key={id} className="mb-10 mx-4">
            ...
            <div className="flex justify-between text-customText2 dark:text-darkText2">
              <p className="py-4 tracking-wide lg:text-xl font-normal">
                {education.degree}
              </p>
              <p className="py-4 lg:text-xl">{education.year}</p>
            </div>
            <ul className="list-disc pl-6 text-customText dark:text-darkText font-normal">
